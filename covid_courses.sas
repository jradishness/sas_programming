...
Output: Table of close classmates with contact info


by Jared Kelly
Last edit: 3/19/20 - Solved first Level, Still need second level
...
%let fname_save = "S:\UIS\Shared\SAS Data Projects\COVID\reports\courses\&affected._COVID_courses_%sysfunc(today(), mmddyy6).xml";
...
ods tagsets.excelxp file=&fname_save. style=XLsansprinter
	options(embedded_titles='yes' autofit_height='yes' sheet_interval='none'
			sheet_name='lvl1' absolute_column_width='15,25,8,28,10,11,25,11,8,9,11,16,9');
