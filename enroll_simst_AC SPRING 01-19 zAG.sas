...
%let fnamesave = "C:\Users\vac0019\OneDrive - UNT System\SAS Data Projects\FriscoEnrollment\EnrollmentRecords\enrollement_dw_2018zag";	* CURRENT ENROLLMENT SAVE DIRECTORY AND NAME;
%let run_type =3OFFICIAL;		* RUN_TYPE MACRO SETTING - 1CURRENT   2CENSUS_DT  2REVIEW  3OFFICIAL; 

options symbolgen;

%macro create(term=1188, term2=2018zag, run=3OFFICIAL, file1=simsterm_s2018zag, file2=s2018zag); ** on file1 official 20th_class_day;
...
DATA ENROLL_ORIG;
  	...
  	IF STRM='1188' AND DW_RUN_DESC='3OFFICIAL';
RUN;
