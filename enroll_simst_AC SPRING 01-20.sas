...
%let fnamesave = "C:\Users\vac0019\OneDrive - UNT System\SAS Data Projects\FriscoEnrollment\EnrollmentRecords\enrollement_dw_2020c_CENSUS";	* CURRENT ENROLLMENT SAVE DIRECTORY AND NAME;
%let run_type = 2CENSUS_DT;		* RUN_TYPE MACRO SETTING - 1CURRENT   2CENSUS_DT  2REVIEW  3OFFICIAL; 

options symbolgen;

%macro create(term=1201, term2=2020C, run=1CURRENT, file1=simsterm_s2020C_CENSUS, file2=s2020C_CENSUS); ** on file1 official 20th_class_day;
...
DATA SIMSTERM;
SET SIMSTERM_ORIG;
IF STRM="&term" THEN SEMESTER="&term2";   /*<-- CHANGE FOR EACH SEMESTER*/ *Summer = GIM**;
RK105=NATIONAL_ID;
SORT_SSN=RK105;
...
DATA ENROLL_ORIG;
  	...
  	IF STRM='1201' AND DW_RUN_DESC='2CENSUS_DT';
RUN;
