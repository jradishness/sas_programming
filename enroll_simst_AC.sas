...
%let fnamesave = "C:\Users\vac0019\OneDrive - UNT System\SAS Data Projects\FriscoEnrollment\EnrollmentRecords\enrollement_dw_2019z_official";	* CURRENT ENROLLMENT SAVE DIRECTORY AND NAME;
%let run_type = 3OFFICIAL;		* RUN_TYPE MACRO SETTING - 1CURRENT   2CENSUS_DT  2REVIEW  3OFFICIAL; 

options symbolgen;

%macro create(term=1198, term2=2019Z, run=3OFFICIAL, file1=simsterm_s2019z_Official, file2=s2019z_Official); ** on file1 official 20th_class_day;
...
DATA ENROLL_ORIG;
  	...
  	IF STRM='1198' AND DW_RUN_DESC='3OFFICIAL';
RUN;
