...
%let fnamesave = "C:\Users\vac0019\OneDrive - UNT System\SAS Data Projects\FriscoEnrollment\Simsterm\enrollement_dw_2020C_CENSUS"; * CURRENT ENROLLMENT SAVE DIRECTORY AND NAME;
%let run_type = 3OFFICIAL;      * RUN_TYPE MACRO SETTING - 1CURRENT   2CENSUS_DT  2REVIEW  3OFFICIAL;

options symbolgen;

%macro create(term=1201, term2=2020C, run=2CENSUS_DT, file1=simsterm_s2020C_CENSUS, file2=s2020C_CENSUS; ** on file1 official 20th_class_day;
